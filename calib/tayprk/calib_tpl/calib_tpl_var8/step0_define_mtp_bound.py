...
mtp_tpl = 'REPLACE_CALIB_DIR/nc_multiplier.tpl'
...
ostin_tmp = 'REPLACE_CALIB_DIR/ostIn_RMSE.tpl' # ostIn_KGE.tpl if obj=KEG; ostIn_RMSE.tpl if obj=RMSE.
ostin_txt = 'REPLACE_CALIB_DIR/ostIn.txt'
mtp_min_default = 0.2 #0.5
mtp_max_default = 2 #1.5
#===Modelers need to change this part according to their case study===
